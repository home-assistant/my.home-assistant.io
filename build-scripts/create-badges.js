...
function myBadge({
  ...
  function renderLabelText() {
    const textColor = "#fff";
    if (label === "MY") {
      return `<g style="stroke-width: .3; stroke: ${textColor};">
